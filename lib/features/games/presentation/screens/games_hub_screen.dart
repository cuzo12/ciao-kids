        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _GameTile(
              emoji: '🧠',
              title: 'Memory Match',
              subtitle: 'Flip cards to match word & picture',
              color: AppColors.secondary,
              onTap: () => context.pushNamed(Routes.memoryMatchName),
            ),
            const SizedBox(height: AppSpacing.md),
            _GameTile(
              emoji: '💶',
              title: 'Numbers & Money',
              subtitle: 'Counting, prices & telling numbers',
              color: AppColors.tertiary,
              onTap: () => context.pushNamed(Routes.numbersGameName),
            ),
          ],
        ),
      ),
